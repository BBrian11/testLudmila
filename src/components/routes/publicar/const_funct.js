...
export let setInitialState = (array, value) => {
...
export const dropdownVariables = {
  type: ["Departamento", "Local comercial", "Casa", "Hotel", "Terreno y lote", "Otro inmueble", "Duplex, Triplex", "Fondo de comercio", "Cochera"],
